...
extern "C" void calculate_crc(Byte<16>*, Byte<64>*, int, int, int, int, int, int, int);
...
std::vector<Byte<16>> __xlx_data_in_crc_out__tmp_vec;
for (size_t i = 0; i < 64; ++i){
__xlx_data_in_crc_out__tmp_vec.push_back(((Byte<16>*)__xlx_apatb_param_data_in)[i]);
}
  int __xlx_size_param_data_in = 64;
  int __xlx_offset_param_data_in = 0;
  int __xlx_offset_byte_param_data_in = 0*16;
for (size_t i = 0; i < 256; ++i){
__xlx_data_in_crc_out__tmp_vec.push_back(((Byte<16>*)__xlx_apatb_param_crc_out)[i]);
}
...
std::vector<Byte<64>> __xlx_tables__tmp_vec;
for (size_t i = 0; i < 256; ++i){
__xlx_tables__tmp_vec.push_back(((Byte<64>*)__xlx_apatb_param_tables)[i]);
}
  int __xlx_size_param_tables = 256;
  int __xlx_offset_param_tables = 0;
  int __xlx_offset_byte_param_tables = 0*64;
  // DUT call
  calculate_crc(__xlx_data_in_crc_out__tmp_vec.data(), __xlx_tables__tmp_vec.data(), __xlx_offset_byte_param_data_in, __xlx_offset_byte_param_crc_out, __xlx_offset_byte_param_tables, __xlx_apatb_param_numChunks, __xlx_apatb_param_chunkSize, __xlx_apatb_param_crc_size, __xlx_apatb_param_init_value);
// print __xlx_apatb_param_data_in
for (size_t i = 0; i < __xlx_size_param_data_in; ++i) {
((Byte<16>*)__xlx_apatb_param_data_in)[i] = __xlx_data_in_crc_out__tmp_vec[__xlx_offset_param_data_in+i];
}
// print __xlx_apatb_param_crc_out
for (size_t i = 0; i < __xlx_size_param_crc_out; ++i) {
((Byte<16>*)__xlx_apatb_param_crc_out)[i] = __xlx_data_in_crc_out__tmp_vec[__xlx_offset_param_crc_out+i];
}
// print __xlx_apatb_param_tables
for (size_t i = 0; i < __xlx_size_param_tables; ++i) {
((Byte<64>*)__xlx_apatb_param_tables)[i] = __xlx_tables__tmp_vec[__xlx_offset_param_tables+i];
}
}
