...
extern "C"
void calculate_crc_hw_stub_wrapper(void*, void*, void*, hls::sim::Byte<4>, hls::sim::Byte<4>, hls::sim::Byte<4>, hls::sim::Byte<4>);

extern "C"
void apatb_calculate_crc_hw(void* __xlx_apatb_param_data_in, void* __xlx_apatb_param_crc_out, void* __xlx_apatb_param_tables, hls::sim::Byte<4> __xlx_apatb_param_numChunks, hls::sim::Byte<4> __xlx_apatb_param_chunkSize, hls::sim::Byte<4> __xlx_apatb_param_crc_size, hls::sim::Byte<4> __xlx_apatb_param_init_value)
{
  ...
  hls::sim::Byte<4> __xlx_offset_byte_param_tables;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_tables),
#endif
  };
  port2.param = &__xlx_offset_byte_param_tables;
  ...
  port3.param = &__xlx_apatb_param_numChunks;
  ...
  port4.param = &__xlx_apatb_param_chunkSize;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_crc_size),
#endif
  };
  port5.param = &__xlx_apatb_param_crc_size;
  ...
  port6.param = &__xlx_apatb_param_init_value;
  ...
  port7.param = { __xlx_apatb_param_data_in, __xlx_apatb_param_crc_out };
  port7.nbytes = { 1024, 4096 };
  port7.offset = { 0, 64 };
  ...
  port8.param = { __xlx_apatb_param_tables };
  port8.nbytes = { 16384 };
  port8.offset = {  };
