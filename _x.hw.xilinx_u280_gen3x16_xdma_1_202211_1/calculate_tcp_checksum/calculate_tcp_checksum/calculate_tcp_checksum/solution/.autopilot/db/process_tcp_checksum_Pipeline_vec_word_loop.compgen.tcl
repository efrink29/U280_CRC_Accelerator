...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_vec_words \
    op interface \
    ports { vec_words { I 26 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { sum_V_2_out { O 47 vector } sum_V_2_out_ap_vld { O 1 bit } } \
} "
}
...
set InstName calculate_tcp_checksum_flow_control_loop_pipe_sequential_init_U
set CompName calculate_tcp_checksum_flow_control_loop_pipe_sequential_init
set name flow_control_loop_pipe_sequential_init
if {${::AESL::PGuard_autocg_gen} && ${::AESL::PGuard_autocg_ipmgen}} {
if {[info proc ::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control] == "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control"} {
eval "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control { \
    name ${name} \
    prefix calculate_tcp_checksum_ \
}"
} else {
