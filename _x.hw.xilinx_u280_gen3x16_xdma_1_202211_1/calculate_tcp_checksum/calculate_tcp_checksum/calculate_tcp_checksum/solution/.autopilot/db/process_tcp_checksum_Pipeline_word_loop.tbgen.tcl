set moduleName process_tcp_checksum_Pipeline_word_loop
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {process_tcp_checksum_Pipeline_word_loop}
set C_modelType { void 0 }
set C_modelArgList {
	{ add_ln645 int 64 regular  }
	{ gmem0 int 512 regular {axi_master 0}  }
	{ trunc_ln1 int 6 regular  }
	{ chunkSize int 32 regular  }
	{ sum_V_1_out int 17 regular {pointer 1}  }
	{ i_1_out int 32 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "add_ln645", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "sum_V_1_out", "interface" : "wire", "bitwidth" : 17, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ add_ln645 sc_in sc_lv 64 signal 0 } 
	{ trunc_ln1 sc_in sc_lv 6 signal 2 } 
	{ chunkSize sc_in sc_lv 32 signal 3 } 
	{ sum_V_1_out sc_out sc_lv 17 signal 4 } 
	{ sum_V_1_out_ap_vld sc_out sc_logic 1 outvld 4 } 
	{ i_1_out sc_out sc_lv 32 signal 5 } 
	{ i_1_out_ap_vld sc_out sc_logic 1 outvld 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "add_ln645", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "add_ln645", "role": "default" }} , 
 	...
 	{ "name": "sum_V_1_out", "direction": "out", "datatype": "sc_lv", "bitwidth":17, "type": "signal", "bundle":{"name": "sum_V_1_out", "role": "default" }} , 
...
set Spec2ImplPortList { 
	add_ln645 { ap_none {  { add_ln645 in_data 0 64 } } }
	...
	sum_V_1_out { ap_vld {  { sum_V_1_out out_data 1 17 }  { sum_V_1_out_ap_vld out_vld 1 1 } } }
