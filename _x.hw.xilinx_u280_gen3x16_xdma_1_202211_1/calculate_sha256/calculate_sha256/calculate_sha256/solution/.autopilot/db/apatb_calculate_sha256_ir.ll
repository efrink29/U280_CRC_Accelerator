; ModuleID = '/home/efrink/mled/split_cu/U280_CRC_Accelerator/_x.hw.xilinx_u280_gen3x16_xdma_1_202211_1/calculate_sha256/calculate_sha256/calculate_sha256/solution/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_calculate_sha256_ir(%"struct.ap_uint<512>"* noalias nocapture nonnull readonly %data_in, i32* noalias nocapture nonnull %crc_out, i32 %numChunks, i32 %chunkSize) local_unnamed_addr #0 {
entry:
  ...
  %2 = getelementptr inbounds [1024 x %"struct.ap_uint<512>"], [1024 x %"struct.ap_uint<512>"]* %data_in_copy, i32 0, i32 0
  %3 = getelementptr inbounds [1024 x i32], [1024 x i32]* %crc_out_copy, i32 0, i32 0
  call void @apatb_calculate_sha256_hw(%"struct.ap_uint<512>"* %2, i32* %3, i32 %numChunks, i32 %chunkSize)
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @"onebyonecpy_hls.p0a1024struct.ap_uint<512>"([1024 x %"struct.ap_uint<512>"]* noalias, [1024 x %"struct.ap_uint<512>"]* noalias readonly) unnamed_addr #2 {
entry:
...
for.loop:                                         ; preds = %for.loop, %copy
  ...
  %5 = load i512, i512* %src.addr.0.0.05, align 64
  store i512 %5, i512* %dst.addr.0.0.06, align 64
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @copy_out([1024 x %"struct.ap_uint<512>"]* noalias, [1024 x %"struct.ap_uint<512>"]* noalias readonly, [1024 x i32]* noalias, [1024 x i32]* noalias readonly) unnamed_addr #3 {
entry:
...
declare void @apatb_calculate_sha256_hw(%"struct.ap_uint<512>"*, i32*, i32, i32)

; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @copy_back([1024 x %"struct.ap_uint<512>"]* noalias, [1024 x %"struct.ap_uint<512>"]* noalias readonly, [1024 x i32]* noalias, [1024 x i32]* noalias readonly) unnamed_addr #3 {
entry:
  call fastcc void @onebyonecpy_hls.p0a1024i32([1024 x i32]* %2, [1024 x i32]* %3)
  ret void
}

define void @calculate_sha256_hw_stub_wrapper(%"struct.ap_uint<512>"*, i32*, i32, i32) #4 {
entry:
  %4 = bitcast %"struct.ap_uint<512>"* %0 to [1024 x %"struct.ap_uint<512>"]*
  %5 = bitcast i32* %1 to [1024 x i32]*
  call void @copy_out([1024 x %"struct.ap_uint<512>"]* null, [1024 x %"struct.ap_uint<512>"]* %4, [1024 x i32]* null, [1024 x i32]* %5)
  %6 = bitcast [1024 x %"struct.ap_uint<512>"]* %4 to %"struct.ap_uint<512>"*
  %7 = bitcast [1024 x i32]* %5 to i32*
  call void @calculate_sha256_hw_stub(%"struct.ap_uint<512>"* %6, i32* %7, i32 %2, i32 %3)
  call void @copy_in([1024 x %"struct.ap_uint<512>"]* null, [1024 x %"struct.ap_uint<512>"]* %4, [1024 x i32]* null, [1024 x i32]* %5)
  ret void
}
