; ModuleID = '/users/arashs/U280_CRC_Accelerator/_x.sw_emu.xilinx_u280_gen3x16_xdma_1_202211_1/calculate_tcp_checksum/calculate_tcp_checksum/calculate_tcp_checksum/solution/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  ...
  call void @apatb_calculate_tcp_checksum_hw([1024 x %"struct.ap_uint<512>"]* %data_in_copy, [1024 x i32]* %crc_out_copy, i32 %numChunks, i32 %chunkSize)
...
declare void @apatb_calculate_tcp_checksum_hw([1024 x %"struct.ap_uint<512>"]*, [1024 x i32]*, i32, i32)
...
define void @calculate_tcp_checksum_hw_stub_wrapper([1024 x %"struct.ap_uint<512>"]*, [1024 x i32]*, i32, i32) #5 {
entry:
  ...
  call void @calculate_tcp_checksum_hw_stub(%"struct.ap_uint<512>"* %4, i32* %5, i32 %2, i32 %3)
