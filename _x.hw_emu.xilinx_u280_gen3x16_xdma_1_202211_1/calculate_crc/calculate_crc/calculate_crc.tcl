...
add_files "/users/arashs/U280_CRC_Accelerator/src/kernel.cpp" -cflags " -g -D KERNEL_VARIANT=KERNEL_VARIANT_CRC -I /users/arashs/U280_CRC_Accelerator/src"
...
config_export -format xo -ipname calculate_crc
csynth_design
export_design
close_project
