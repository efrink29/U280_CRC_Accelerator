...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { numChunks_dout { I 32 vector } numChunks_num_data_valid { I 2 vector } numChunks_fifo_cap { I 2 vector } numChunks_empty_n { I 1 bit } numChunks_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_crc_out \
    op interface \
    ports { crc_out_dout { I 64 vector } crc_out_num_data_valid { I 3 vector } crc_out_fifo_cap { I 3 vector } crc_out_empty_n { I 1 bit } crc_out_read { O 1 bit } } \
} "
}
