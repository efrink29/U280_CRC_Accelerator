...
HD_PWD='/users/arashs/U280_CRC_Accelerator/_x.hw_emu.xilinx_u280_gen3x16_xdma_1_202211_1/calculate_sha256/calculate_sha256'
cd "$HD_PWD"
...
EAStep vitis_hls -f calculate_sha256.tcl -messageDb vitis_hls.pb
