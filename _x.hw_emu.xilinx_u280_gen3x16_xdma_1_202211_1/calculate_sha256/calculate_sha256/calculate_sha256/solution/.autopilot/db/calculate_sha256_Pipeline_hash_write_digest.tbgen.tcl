set moduleName calculate_sha256_Pipeline_hash_write_digest
set isTopModule 0
...
set C_modelName {calculate_sha256_Pipeline_hash_write_digest}
...
set C_modelArgList {
	...
	{ trunc_ln621_1 int 6 regular  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 512, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "data_in","offset": { "type": "dynamic","port_name": "data_in","bundle": "control"},"direction": "READONLY"},{"cName": "crc_out","offset": { "type": "dynamic","port_name": "crc_out","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "trunc_ln621_1", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ digest sc_in sc_lv 32 signal 1 } 
	{ digest_1 sc_in sc_lv 32 signal 2 } 
	{ digest_2 sc_in sc_lv 32 signal 3 } 
	{ digest_3 sc_in sc_lv 32 signal 4 } 
	{ digest_4 sc_in sc_lv 32 signal 5 } 
	{ digest_5 sc_in sc_lv 32 signal 6 } 
	{ digest_6 sc_in sc_lv 32 signal 7 } 
	{ digest_7 sc_in sc_lv 32 signal 8 } 
	{ c sc_in sc_lv 32 signal 9 } 
	{ crc_out sc_in sc_lv 64 signal 10 } 
	{ trunc_ln621_1 sc_in sc_lv 6 signal 11 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "trunc_ln621_1", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "trunc_ln621_1", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_8_3_32_1_1_U69", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	trunc_ln621_1 { ap_none {  { trunc_ln621_1 in_data 0 6 } } }
}
