...
extern "C" void calculate_sha256(Byte<64>*, int, int, int, int);
...
std::vector<Byte<64>> __xlx_data_in_crc_out__tmp_vec;
for (size_t i = 0; i < 1024; ++i){
__xlx_data_in_crc_out__tmp_vec.push_back(((Byte<64>*)__xlx_apatb_param_data_in)[i]);
}
  int __xlx_size_param_data_in = 1024;
  int __xlx_offset_param_data_in = 0;
  int __xlx_offset_byte_param_data_in = 0*64;
for (size_t i = 0; i < 64; ++i){
__xlx_data_in_crc_out__tmp_vec.push_back(((Byte<64>*)__xlx_apatb_param_crc_out)[i]);
}
  int __xlx_size_param_crc_out = 64;
  int __xlx_offset_param_crc_out = 1024;
  int __xlx_offset_byte_param_crc_out = 1024*64;
  // DUT call
  calculate_sha256(__xlx_data_in_crc_out__tmp_vec.data(), __xlx_offset_byte_param_data_in, __xlx_offset_byte_param_crc_out, __xlx_apatb_param_numChunks, __xlx_apatb_param_chunkSize);
// print __xlx_apatb_param_data_in
for (size_t i = 0; i < __xlx_size_param_data_in; ++i) {
((Byte<64>*)__xlx_apatb_param_data_in)[i] = __xlx_data_in_crc_out__tmp_vec[__xlx_offset_param_data_in+i];
}
// print __xlx_apatb_param_crc_out
for (size_t i = 0; i < __xlx_size_param_crc_out; ++i) {
((Byte<64>*)__xlx_apatb_param_crc_out)[i] = __xlx_data_in_crc_out__tmp_vec[__xlx_offset_param_crc_out+i];
}
}
