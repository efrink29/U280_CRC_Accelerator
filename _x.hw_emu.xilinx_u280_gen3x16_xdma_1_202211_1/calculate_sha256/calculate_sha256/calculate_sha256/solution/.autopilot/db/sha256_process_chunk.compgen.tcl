...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler calculate_sha256_sha256_process_chunk_pad_block_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
