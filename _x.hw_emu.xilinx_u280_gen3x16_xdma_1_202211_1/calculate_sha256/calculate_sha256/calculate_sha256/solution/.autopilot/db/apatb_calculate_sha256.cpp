...
// wrapc file define:
#define AUTOTB_TVIN_data_in "../tv/cdatafile/c.calculate_sha256.autotvin_data_in.dat"
#define AUTOTB_TVOUT_data_in "../tv/cdatafile/c.calculate_sha256.autotvout_data_in.dat"
#define AUTOTB_TVIN_crc_out "../tv/cdatafile/c.calculate_sha256.autotvin_crc_out.dat"
#define AUTOTB_TVOUT_crc_out "../tv/cdatafile/c.calculate_sha256.autotvout_crc_out.dat"
#define AUTOTB_TVIN_numChunks "../tv/cdatafile/c.calculate_sha256.autotvin_numChunks.dat"
#define AUTOTB_TVOUT_numChunks "../tv/cdatafile/c.calculate_sha256.autotvout_numChunks.dat"
#define AUTOTB_TVIN_chunkSize "../tv/cdatafile/c.calculate_sha256.autotvin_chunkSize.dat"
#define AUTOTB_TVOUT_chunkSize "../tv/cdatafile/c.calculate_sha256.autotvout_chunkSize.dat"
#define AUTOTB_TVIN_gmem0 "../tv/cdatafile/c.calculate_sha256.autotvin_gmem0.dat"
#define AUTOTB_TVOUT_gmem0 "../tv/cdatafile/c.calculate_sha256.autotvout_gmem0.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_gmem0 "../tv/rtldatafile/rtl.calculate_sha256.autotvout_gmem0.dat"
...
extern "C"
void calculate_sha256_hw_stub_wrapper(void*, void*, hls::sim::Byte<4>, hls::sim::Byte<4>);

extern "C"
void apatb_calculate_sha256_hw(void* __xlx_apatb_param_data_in, void* __xlx_apatb_param_crc_out, hls::sim::Byte<4> __xlx_apatb_param_numChunks, hls::sim::Byte<4> __xlx_apatb_param_chunkSize)
{
  ...
  hls::sim::Byte<4> __xlx_offset_byte_param_crc_out;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_crc_out),
#endif
  };
  port1.param = &__xlx_offset_byte_param_crc_out;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_numChunks),
#endif
  };
  port2.param = &__xlx_apatb_param_numChunks;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_chunkSize),
#endif
  };
  port3.param = &__xlx_apatb_param_chunkSize;
  ...
  port4.param = { __xlx_apatb_param_data_in, __xlx_apatb_param_crc_out };
  port4.nbytes = { 65536, 4096 };
  port4.offset = { 0, 1024 };
  ...
  try {
    ...
    calculate_sha256_hw_stub_wrapper(__xlx_apatb_param_data_in, __xlx_apatb_param_crc_out, __xlx_apatb_param_numChunks, __xlx_apatb_param_chunkSize);
