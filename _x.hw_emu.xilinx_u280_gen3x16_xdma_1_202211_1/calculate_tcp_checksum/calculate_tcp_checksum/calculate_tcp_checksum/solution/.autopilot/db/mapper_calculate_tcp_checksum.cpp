...
extern "C" void calculate_tcp_checksum(Byte<64>*, int, int, int, int);
...
__xlx_data_in_crc_out__tmp_vec.push_back(((Byte<64>*)__xlx_apatb_param_crc_out)[i]);
  ...
  // DUT call
  calculate_tcp_checksum(__xlx_data_in_crc_out__tmp_vec.data(), __xlx_offset_byte_param_data_in, __xlx_offset_byte_param_crc_out, __xlx_apatb_param_numChunks, __xlx_apatb_param_chunkSize);
