...
set TopModule "calculate_tcp_checksum"
...
set MaxFanout 0
set RtlPrefix {}
set RtlSubPrefix calculate_tcp_checksum_
set ExtraCCFlags {}
set ExtraCLdFlags {}
set SynCheckOptions {}
set PresynOptions {}
...
set SourceFlags {sc {} c {{-g -DKERNEL_VARIANT=KERNEL_VARIANT_TCP -I/users/arashs/U280_CRC_Accelerator/src}}}
set DirectiveFile {}
