; ModuleID = '/users/arashs/U280_CRC_Accelerator/_x.hw_emu.xilinx_u280_gen3x16_xdma_1_202211_1/calculate_tcp_checksum/calculate_tcp_checksum/calculate_tcp_checksum/solution/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_calculate_tcp_checksum_ir(%"struct.ap_uint<512>"* noalias nocapture nonnull readonly "maxi" %data_in, i32* noalias nocapture nonnull "maxi" %crc_out, i32 %numChunks, i32 %chunkSize) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_calculate_tcp_checksum_hw([1024 x i512]* %data_in_copy, [1024 x i32]* %crc_out_copy, i32 %numChunks, i32 %chunkSize)
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @"onebyonecpy_hls.p0a1024struct.ap_uint<512>"([1024 x i512]* noalias %dst, [1024 x %"struct.ap_uint<512>"]* noalias readonly %src) unnamed_addr #2 {
entry:
...
copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a1024struct.ap_uint<512>"([1024 x i512]* nonnull %dst, [1024 x %"struct.ap_uint<512>"]* nonnull %src, i64 1024)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse
define void @"arraycpy_hls.p0a1024struct.ap_uint<512>"([1024 x i512]* %dst, [1024 x %"struct.ap_uint<512>"]* readonly %src, i64 %num) local_unnamed_addr #3 {
entry:
...
for.loop:                                         ; preds = %for.loop, %for.loop.lr.ph
  ...
  %3 = getelementptr [1024 x i512], [1024 x i512]* %dst, i64 0, i64 %for.loop.idx8
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @copy_out([1024 x %"struct.ap_uint<512>"]* noalias, [1024 x i512]* noalias readonly, [1024 x i32]* noalias, [1024 x i32]* noalias readonly) unnamed_addr #4 {
entry:
  call fastcc void @"onebyonecpy_hls.p0a1024struct.ap_uint<512>.8"([1024 x %"struct.ap_uint<512>"]* %0, [1024 x i512]* %1)
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @"onebyonecpy_hls.p0a1024struct.ap_uint<512>.8"([1024 x %"struct.ap_uint<512>"]* noalias %dst, [1024 x i512]* noalias readonly %src) unnamed_addr #2 {
entry:
...
copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a1024struct.ap_uint<512>.11"([1024 x %"struct.ap_uint<512>"]* nonnull %dst, [1024 x i512]* nonnull %src, i64 1024)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse
define void @"arraycpy_hls.p0a1024struct.ap_uint<512>.11"([1024 x %"struct.ap_uint<512>"]* %dst, [1024 x i512]* readonly %src, i64 %num) local_unnamed_addr #3 {
entry:
...
for.loop:                                         ; preds = %for.loop, %for.loop.lr.ph
  %for.loop.idx8 = phi i64 [ 0, %for.loop.lr.ph ], [ %for.loop.idx.next, %for.loop ]
  %3 = getelementptr [1024 x i512], [1024 x i512]* %src, i64 0, i64 %for.loop.idx8
...
declare void @apatb_calculate_tcp_checksum_hw([1024 x i512]*, [1024 x i32]*, i32, i32)

; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @copy_back([1024 x %"struct.ap_uint<512>"]* noalias, [1024 x i512]* noalias readonly, [1024 x i32]* noalias, [1024 x i32]* noalias readonly) unnamed_addr #4 {
entry:
  call fastcc void @onebyonecpy_hls.p0a1024i32([1024 x i32]* %2, [1024 x i32]* %3)
  ret void
}

define void @calculate_tcp_checksum_hw_stub_wrapper([1024 x i512]*, [1024 x i32]*, i32, i32) #5 {
entry:
  %malloccall = tail call i8* @malloc(i64 65536)
  %4 = bitcast i8* %malloccall to [1024 x %"struct.ap_uint<512>"]*
  call void @copy_out([1024 x %"struct.ap_uint<512>"]* %4, [1024 x i512]* %0, [1024 x i32]* null, [1024 x i32]* %1)
  %5 = bitcast [1024 x %"struct.ap_uint<512>"]* %4 to %"struct.ap_uint<512>"*
  %6 = bitcast [1024 x i32]* %1 to i32*
  call void @calculate_tcp_checksum_hw_stub(%"struct.ap_uint<512>"* %5, i32* %6, i32 %2, i32 %3)
  call void @copy_in([1024 x %"struct.ap_uint<512>"]* %4, [1024 x i512]* %0, [1024 x i32]* null, [1024 x i32]* %1)
  ret void
}
