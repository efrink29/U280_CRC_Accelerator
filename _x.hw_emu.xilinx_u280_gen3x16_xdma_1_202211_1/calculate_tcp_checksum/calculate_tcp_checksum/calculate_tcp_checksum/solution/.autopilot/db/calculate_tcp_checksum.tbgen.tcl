set moduleName calculate_tcp_checksum
set isTopModule 1
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READWRITE", "bitSlice":[ {"cElement": [{"cName": "data_in","offset": { "type": "dynamic","port_name": "data_in","bundle": "control"},"direction": "READONLY"},{"cName": "crc_out","offset": { "type": "dynamic","port_name": "crc_out","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "numChunks", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "offset" : {"in":40}, "offset_end" : {"in":47}} , 
 	{ "Name" : "chunkSize", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "offset" : {"in":48}, "offset_end" : {"in":55}} ]}
...
set NewPortList {[ 
	{ "name": "s_axi_control_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "control", "role": "AWADDR" },"address":[{"name":"calculate_tcp_checksum","role":"start","value":"0","valid_bit":"0"},{"name":"calculate_tcp_checksum","role":"continue","value":"0","valid_bit":"4"},{"name":"calculate_tcp_checksum","role":"auto_start","value":"0","valid_bit":"7"},{"name":"data_in","role":"data","value":"16"},{"name":"crc_out","role":"data","value":"28"},{"name":"numChunks","role":"data","value":"40"},{"name":"chunkSize","role":"data","value":"48"}] },
	...
	{ "name": "s_axi_control_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "control", "role": "ARADDR" },"address":[{"name":"calculate_tcp_checksum","role":"start","value":"0","valid_bit":"0"},{"name":"calculate_tcp_checksum","role":"done","value":"0","valid_bit":"1"},{"name":"calculate_tcp_checksum","role":"idle","value":"0","valid_bit":"2"},{"name":"calculate_tcp_checksum","role":"ready","value":"0","valid_bit":"3"},{"name":"calculate_tcp_checksum","role":"auto_start","value":"0","valid_bit":"7"}] },
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "8", "9"],
		...
		"Port" : [
			{"Name" : "gmem0", "Type" : "MAXI", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_process_tcp_checksum_fu_86", "Port" : "gmem0", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_process_tcp_checksum_fu_86", "Parent" : "0", "Child" : ["2", "4", "6"],
