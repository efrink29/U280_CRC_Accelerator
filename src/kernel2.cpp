...
static void process_blocks(uint32_t crcTables[BLOCK_SIZE][TABLE_SIZE], 
                ...
                bStream& byte8, bStream& byte9, bStream& byte10, bStream& byte11, 
                bStream& byte12, bStream& byte13, bStream& byte14, bStream& byte15, 
                const uint32_t crc_size, unsigned int numBlocks, const uint32_t init_value, unsigned int* crc_out) {
...
*/
extern "C" {
void calculate_crc(const unsigned char* data_in, unsigned int* crc_out, const unsigned int numBlocks, const uint32_t* tables, const uint32_t crc_size, const uint32_t init_value) {
...
#pragma HLS PIPELINE
   ...
   #pragma HLS DATAFLOW
   read_input(data_in, inByte0, inByte1, inByte2, inByte3, inByte4, inByte5, inByte6, inByte7, inByte8, inByte9, inByte10, inByte11, inByte12, inByte13, inByte14, inByte15, numBlocks);
   process_blocks(crcTables, inByte0, inByte1, inByte2, inByte3, inByte4, inByte5, inByte6, inByte7, inByte8, inByte9, inByte10, inByte11, inByte12, inByte13, inByte14, inByte15, crc_size, numBlocks, init_value, crc_out);
